...
const Afterlr = ({setLoginUser}) => {
    return (
        <div className="afterlr">
            ...
            <button className="button2"><a href ="#" style={{textDecoration:'none', color:'white'}}>Customer Manager Area</a></button>
            <button className="button2"><a href ="#" style={{textDecoration:'none', color:'white'}}>Item Manager Area</a></button>
            <br></br>
